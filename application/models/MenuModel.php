...
class MenuModel extends CI_Model{
    ...
    public function GetAllAdminSubMenu() {
        $result = $this->db->query("SELECT asub.*, ad.MenuName as MainMenu, rt.Role as RollName, IF(asub.isHide>0, 'Yes','No') as isHideStatus, IF(asub.isForSuper>0, 'Yes','No') as isForSuperStatus FROM adminsubmenu1 asub join adminmenu ad on ad.ID=asub.MainMenuID join role_tbl rt on rt.Id=asub.Role  ORDER  by ad.Sort, asub.Sort")->result();
