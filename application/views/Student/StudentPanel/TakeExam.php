...
<div style="position:fixed; top:340px; right: 50px;" ng-show="ShowCheckResultBtn == 1">
        ...
        <table class="table" style="margin-left:0px;">
             <div id="myProgress" class="sticky">
                      <div id="myBar"></div>
            </div>
            <tr>
                <th>Question </th>
            ...
            <tr ng-repeat="Item in AllQuestion.OnlyQuestion">
                ...
                <span ng-hide="Item.Click == 1" >
                        ...
                        <p style="padding: 5px; padding-left:0px;  font-family: 'Times New Roman', Times, serif; font-size: 17px; font-weight:bold;"> <b>{{$index + 1}}]</b>  {{Item.Question}} </p>
                 ...
                 <span ng-show="AnswerAccepted == 1" >
                    
                    <b id="Answered"> {{$index + 1}}]  উত্তর দেওয়া হয়েছে     </b>
                </span>   
