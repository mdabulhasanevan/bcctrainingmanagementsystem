   ...
   <div class="content">
      ...
      id="fullScreen"  class=" btn btn-lg" ng-show="showBtn==0"  >
        ...
        <ol class="list-group">
            ...
            <li class="list-group-item">> উত্তর দিতে ডাবল ক্লিক করুন  </li>
...
<div style="position:fixed; top:340px; right: 50px;" ng-show="ShowCheckResultBtn == 1">
        ...
        <table class="table" style="margin-left:0px;">
            ...
            <tr ng-repeat="Item in AllQuestion.OnlyQuestion">
                <td style="">  <span ng-hide="Item.Click == 1" style="padding-left:35px; padding: 5px; font-family: 'Times New Roman', Times, serif; font-size: 17px;  " class="">{{$index + 1}}] {{Item.Question}} </span> 
                   <br><br>
                    <span  ng-dblclick="Item.Click = 1" style="font-weight: bold; margin-left:23px;" ng-hide="Item.Click == 1" ng-repeat="x in AllQuestion.AllQuestion| filter:{QId:Item.QId}">
                       
                        <span href="#" data-toggle="tooltip" data-placement="right"  ng-hide="Item.Click == 1" ng-model="x.Selected"  title="Click after being sure..!" ng-dblclick="x.Selected = 1; TakeAns(x)"  style="margin:3px;  font-weight:bold; color:black;"  class="btn btn-light"> 
