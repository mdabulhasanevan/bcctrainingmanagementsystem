        ...
        <table class="table table-striped">
            <tr>
               ...
               <!-- <th> Is Certified </th>-->
                ...
                <th>Is Certified </th>
                 <th> <a target="_new" class="btn btn-info" href="<?php echo  base_url(); ?>Student/MyCertificatePdfMultiple/{{BatchID}}"> <span class="glyphicon glyphicon-certificate">  Download ALL</span></a>     </th>
            </tr>
...
<!--                    <button class="btn btn-small btn-warning" data-toggle="modal" data-target="#myModal" ng-click="Edit(Student3)" >Edit</button>
                ...
                <td>
                <a target="_new" class="btn btn-info" href="<?php echo  base_url(); ?>Student/MyCertificatePdfIndividual/{{Student3.SID}}"> <span class="glyphicon glyphicon-certificate"> Certificate</span></a>    
