<div class="content-page" ng-controller="DefaultCtrl">
            ...
            <div class="form-group col-md-3">
                <label for="Exam" >To</label>
                  <input class="form-control" id="MonthTo" ng-model="Month.ToMonth" autocomplete="off" name="ToMonth" ng-change="GetBatchMonthlyReport()" />
        ...
        <h5 style="text-align:center;"><b>  Report ( Based on Starting Date   </b>) <br>within   {{Month.ThisMonth}} to {{Month.ToMonth}} </h5>
    ...
    app.controller("DefaultCtrl", ["$scope", "$http",
        function ($scope, $http) {
            ...
            function initialize() {
                ...
                $scope.GetBatchMonthlyReport=GetBatchMonthlyReport;
            ...
            function GetBatchMonthlyReport()
            {
               ...
               // var MonthFrom = MonthFrom.substring(5, 7);
               // var YearFrom = MonthFrom.substring(0, 4);
                
               // var MonthTo = MonthTo.substring(5, 7);
               // var YearTo = MonthTo.substring(0, 4);
                
                $scope.AllBatch = [];
                $http({
                    method: 'GET',
                    url: baseUrl + 'Report/GetBatchMonthlyReport/'+MonthFrom+'/'+MonthTo
